...
require('lazy').setup({
  ...
  --
  --     -- Define LSP server configurations using native vim.lsp
  --     local servers = {
  --       lua_ls = {
  ...
  --     }
  --
  --     -- Function to start LSP servers using vim.lsp.start
  --     local function setup_lsp_server(server_name, config)
  --       -- Create autocommand to start LSP when appropriate files are opened
  --       vim.api.nvim_create_autocmd('FileType', {
  --         pattern = config.filetypes,
  --         callback = function(args)
  --           local root_dir = config.root_dir and config.root_dir(args.file) or vim.fn.getcwd()
  ...
  --     end
  --
  --     -- Setup each server using vim.lsp.start
  ...
  --
  --     -- Optional: Keep mason-lspconfig for easier server management
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        typescriptrc = { 'biome', 'prettierd', 'prettier', stop_after_first = true },
